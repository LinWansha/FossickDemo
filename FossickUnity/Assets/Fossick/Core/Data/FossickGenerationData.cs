...
{
    [Serializable]
    public sealed class FossickGenerationData
    {
        public int seed;
        ...
        public FossickGenerationData()
        {
        }

        public FossickGenerationData(int seed)
        {
            this.seed = seed;
            randomState = seed;
        }

        public FossickGenerationData Clone()
        {
            return new FossickGenerationData
            {
                seed = seed,
